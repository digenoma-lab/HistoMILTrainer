...
class GridSearchTransfer:
    ...
    def __init__(self, folds, features_path, splits_dir, csv_path, results_dir, feature_extractor="uni_v2", 
                 ...
                 *, model_params_path, transfer_mode, pretrained_checkpoint=None,):
        """
        ...
        Args:
            ...
            transfer_mode: Transfer strategy: scratch or full
            pretrained_checkpoint: Source checkpoint required for full
        """
        self.folds = folds
        ...
        if self.transfer_mode not in {"scratch", "full"}:
            raise ValueError(
                "transfer_mode debe ser 'scratch' o 'full'. "
